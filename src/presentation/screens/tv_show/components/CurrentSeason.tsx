    ...
    <View>
      ...
      <View style={currentSeasonStyle.row}>
        ...
        <View style={currentSeasonStyle.infoContainer}>
          ...
          <Text style={currentSeasonStyle.subtitle}>
            {strDateToYear(season.airDate)} | {season.episodeCount} episodes
          </Text>
          <Text
            style={currentSeasonStyle.seasonOverview}
            numberOfLines={4}
            ellipsizeMode="tail">
            {season.overview || season.name} of {tvShowTitle} premiered on{' '}
            {season.airDate}
          </Text>
        </View>
      </View>

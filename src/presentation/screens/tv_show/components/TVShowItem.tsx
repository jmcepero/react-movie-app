...
export const TVShowItem = ({ tvShow, onTVShowClicked, width = 160, height = 220 }: TVShowItemProps) => {
    return (
        <View style={{
            paddingVertical: 8,
            paddingHorizontal: 8
            ...
            <View style={{
                ...
                <Text style={[styles.movieTitle, { width: 90 }]} numberOfLines={1} ellipsizeMode={'tail'}>{tvShow.name}</Text>
                <ValorationView average={tvShow.voteAverage} iconSize={12} />
            </View>

            <Text style={styles.yearTitle}>{new Date(tvShow.firstAirDate).getFullYear()}</Text>

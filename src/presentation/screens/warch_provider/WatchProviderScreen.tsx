...
interface WatchProviderProps extends StackScreenProps<RootStackParams, 'WatchProviderScreen'> { };
      ...
      <SectionList
        ...
        renderItem={({ item }) => (
          <View style={styles.providerRow}>
            <FadeInImage uri={`https://image.tmdb.org/t/p/w500${item.logoPath}`} style={styles.logo} />

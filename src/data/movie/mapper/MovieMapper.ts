...
export const movieDetailResponseToDetail = (movieDetailResponse: MovieDetailResponse): Movie => {
    ...
    return {
        ...
        director: movieDetailResponse.credits ? movieDetailResponse.credits.crew.find((cast) => {
            return cast.known_for_department === 'Directing'
        })?.name : undefined,
        trailer: movieDetailResponse.videos ? movieDetailResponse.videos.results.find((video) => {

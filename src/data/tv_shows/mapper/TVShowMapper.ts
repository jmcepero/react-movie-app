...
export const tvShowDetailResponseToDomain = (
  ...
  return {
    ...
    credits: tvShowDetailResponse.credits
      ...
      : undefined,
    director: tvShowDetailResponse.credits
      ? tvShowDetailResponse.credits.crew.find(cast => {
          return cast.known_for_department === 'Directing';
        })?.name
      : undefined,
    trailer: tvShowDetailResponse.videos
      ? tvShowDetailResponse.videos.results.find(video => {
